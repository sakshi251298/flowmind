...
### Aesthetic
Flat, clean, white surfaces. Minimal 0.5px borders. Generous whitespace. No gradients, no shadows (except functional focus rings). Everything should feel native to FlowMind — like it belongs on the page, not embedded from somewhere else.
