...
import { Badge } from '@flowmind/ui/badge';
import {
  Globe,
  BookOpen,
  ExternalLink,
...
import {
  ...
  DialogHeader,
  DialogTitle,
} from '@flowmind/ui/dialog';
import { ScrollArea } from '@flowmind/ui/scroll-area';
import { Button } from '@flowmind/ui/button';
import { Input } from '@flowmind/ui/input';
            ...
            <div className="rounded-2xl border border-border/65 bg-gradient-to-br from-secondary/65 to-card p-4">
              <div className="mb-3 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-caption text-muted-foreground">
                    The material FlowMind is grounding the session in.
                  </p>
                </div>
              </div>
