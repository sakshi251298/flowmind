...
import { Button } from '@flowmind/ui/button';
import {
  Card,
  CardContent,
  CardDescription,
...
const setupSteps = [
  {
    ...
    detail: 'Pull FlowMind locally from GitHub and move into the monorepo workspace.',
    command: 'git clone https://github.com/sakshi251298/flowmind\ncd flowmind',
  },
  {
    step: '02',
      ...
      <main id="home" className="relative z-10">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-5">
                ...
                <p className="max-w-lg text-lg leading-8 text-muted-foreground sm:text-xl">
                  FlowMind turns one prompt into a complete learning system that you can
              ...
              <div className="relative h-[30rem] sm:h-[29rem] w-full max-w-[90rem] mx-auto group perspective-[2000px]">
                ...
                <div className="absolute inset-0 rounded-[2.5rem] border border-border/40 bg-card/40 backdrop-blur-3xl shadow-[0_36px_90px_rgba(73,45,28,0.12)] transition-all duration-700 group-hover:rotate-x-2 overflow-hidden z-10 hover:z-[100]">
                  <div className="absolute inset-x-0 top-0 z-10 flex items-center justify-between p-6 bg-gradient-to-b from-black/50 to-transparent">
                    ...
                    <span className="text-sm font-medium text-white/90 drop-shadow-md">FlowMind Platform</span>
                  </div>
                  <video
                    ref={videoRef}
                    autoPlay
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <p className="mt-2 max-w-xl text-sm leading-6 text-muted-foreground">
                        A quick visual look at how this part of FlowMind feels in practice, from the
        ...
        <section id="features" className="mx-auto max-w-360 px-5 py-20 sm:px-8 lg:py-24">
          <div className="mb-10 max-w-3xl space-y-4">
            ...
            <p className="section-copy">
              The product experience is the pitch. FlowMind does not stop at answers; it keeps
        ...
        <section id="workflow" className="relative overflow-hidden border-y border-border/60 bg-card/30">
          <div className="mx-auto max-w-360 px-5 py-20 sm:px-8 lg:py-24">
            <div className="mb-12 max-w-3xl space-y-4">
              ...
              <p className="section-copy">
                FlowMind keeps the learning loop simple while the system underneath does the heavy
            ...
            <div className="grid gap-5 lg:grid-cols-3">
              {[
                ...
                },
                {
                  step: '03',
                  title: 'Master',
                  copy: 'FlowMind turns the session into reusable outputs so the next revision session begins with structure instead of friction.',
                  icon: GraduationCap,
                },
            ...
            <div className="relative z-10 flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
              <div className="space-y-3">
                ...
                <p className="max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
                  FlowMind is a polyglot system built for scale, modularity, and autonomy. Explore the
      ...
      <footer className="border-t border-border/60 bg-card/45">
        <div className="mx-auto flex max-w-360 flex-col gap-8 px-5 py-10 sm:px-8 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            <p className="font-heading text-2xl tracking-tight">FlowMind</p>
