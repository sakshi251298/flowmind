...
First off, thank you for considering contributing to FlowMind! We welcome contributions of all sizes—whether it's a bug fix, new feature, documentation improvement, or a design polish.
...
2. **Clone your fork** locally: `git clone https://github.com/sakshi251298/flowmind.git`
...
### Monorepo Practices
FlowMind uses Turborepo. When adding a shared UI element, it should go into `packages/ui` so it can be consumed by other apps.
