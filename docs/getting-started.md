...
Welcome to FlowMind! This guide will help you set up the project locally for development or demonstration purposes.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/sakshi251298/flowmind.git
   cd flowmind
   ```
...
- **UI doesn't update**: Double check that `pnpm dev` successfully built `@flowmind/ui` (visible in turbo logs).
